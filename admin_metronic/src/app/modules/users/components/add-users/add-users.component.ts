...
import { User } from 'src/app/modules/material/formcontrols/autocomplete/autocomplete.component';
...
export class AddUsersComponent implements OnInit {
  ...
  save(){
    if (this.name == null || this.surname == null || this.email == null || this.password == null || this.repeat_password == null) {
